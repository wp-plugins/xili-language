...
**NEW: 0.9.7.3**
Add a box in post admin edit UI to easily set link to similar posts in other language (as formerly with custom fields).
**NEW: 0.9.7.1**
...
= 0.9.7.3 = Add a box in post admin edit UI - fixes in hooks -
