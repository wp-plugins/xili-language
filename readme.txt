...
= 1.8.5 =
* improve automatic languages sub-folder detection and caution message if `load_textdomain()` is missing in functions.php.
* repairs oversight about bookmarks taxonomies (blogroll).
= 1.8.4 = 
