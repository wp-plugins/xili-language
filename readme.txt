...
= 0.9.9.3 = sub selection of pages for `wp_list_pages()` with &lang=, some fixes (other posts, options when activate,...) and soon [examples](http://dev.xiligroup.com/xili-tidy-tags/) (how to install selected rss...)
