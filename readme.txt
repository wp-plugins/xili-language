...
6. The language dashboard in post writting UI under the content textarea.
7. List of posts with language column and infos about linked posts.
...
= 2.5.0 =
* new metabox centralizing translations and links of posts
