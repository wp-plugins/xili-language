...
class xili_Widget_Categories extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 'classname' => 'widget_categories', 'description' => __( "A multilingual list or dropdown of categories." ) );
		parent::__construct('xl_categories', '[©xili] ' . __('Categories'), $widget_ops);
	}
