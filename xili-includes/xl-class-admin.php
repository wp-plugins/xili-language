<?php
/**
 * class xili_language_admin - 2.6.3 - 2.7.1 - 2.8.0 - 2.8.3 - 2.8.4 - 2.8.4.1 - 2.8.4.2 
 *
 * 2013-02-16
 */
		...
		if ( current_theme_supports( 'menus' ) ) { ?>
	 	...
	 	<fieldset class="box"><legend><?php echo __("Nav menu: Home links in each language",'xili-language'); ?></legend>
			...
			<label for="nav_menu_separator" class="selectit"><?php _e('Separator before language list (<em>Character or Entity Number or Entity Name</em>)', 'xili-language'); ?> : <input id="nav_menu_separator" name="nav_menu_separator" type="text" value="<?php echo htmlentities(stripslashes($this->xili_settings['nav_menu_separator'])) ?>"  /> </label><br /><br />
	 		...
	 		<fieldset class="box rightbox">
	 		<label for="xili_home_item_nav_menu" class="selectit"><input id="xili_home_item_nav_menu" name="xili_home_item_nav_menu" type="checkbox" value="modify"  <?php if($this->xili_settings['home_item_nav_menu'] =='modify') echo 'checked="checked"' ?> /> <?php _e('Menu Home item with language.', 'xili-language'); ?></label></fieldset>
	 		<br />
	 		...
	 		<fieldset class="box"><legend><?php echo __("Nav menu: Automatic sub-selection of pages according current language",'xili-language'); ?></legend>
	 			<fieldset class="box leftbox">
					<?php _e('Choose location of nav menu where sub-selection of pages list will be automatically inserted according current displayed language:','xili-language'); ?><br /><?php _e('Args is like in function wp_list_pages, example: <em>include=11,15</em>','xili-language'); ?>
				</fieldset>
		 		<fieldset class="box rightbox">
	...
	function available_languages_row() { 	
		...
		foreach ($listlanguages as $language) {	
			...
			if ( $this->alias_mode ) {
				...
				//error_log ( $alias_val . '*****'.count ( $key_slug ));
				if ( count ( $key_slug ) == 1 ) {
