...
define('XILILANGUAGE_VER','1.8.9.3'); /* used in admin UI*/
...
class xili_language {
	...
	function set_when_plugin_loaded () {
		 ...
		 */
		register_taxonomy( TAXONAME, 'post', array('hierarchical' => false, 'label' => false, 'rewrite' => true , 'update_count_callback' => array(&$this, '_update_post_lang_count'), 'show_ui' => false, '_builtin' => false, 'query_var' => 'lang' ));
