...
define('XILILANGUAGE_VER','0.9.7.3');
...
class xili_language {
	...
	function xili_language() {
		...
		/* new actions for xili-language theme's templates tags - fixes 0.9.7.3*/
		
		$this->add_action('xili_language_list','xili_language_list',10,2);
