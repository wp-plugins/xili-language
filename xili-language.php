...
*/
# updated 130422 - 130503 - 2.8.8 - fixes notice with bbPress 2.3 - try to find .mo files at automattic svn and GlotPress - best title in href language list - new way to insert languages list in navigation menu - better filter in menu/widget title
...
define('XILILANGUAGE_VER', '2.8.8-b2'); /* used in admin UI*/
...
class xili_language {
	...
	function only_parent_construct () {	
		...
		if ( !is_admin() ) {
			...
			add_filter( 'wp_nav_menu_items', array(&$this,'insert_language_list_in_nav_menu' ), 10, 2 );
