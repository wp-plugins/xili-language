...
define('XILILANGUAGE_VER', '2.10.0'); /* used in admin UI*/
...
class xili_language {
	...
	function only_parent_construct () {
		...
		if( false === $this->xili_settings ) { //1.9.1
			...
			if ( ! isset ( $this->xili_settings['version'] ) || $this->xili_settings['version'] != '2.9') { // repair or restart from new
