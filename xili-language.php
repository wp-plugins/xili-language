...
# updated 140622 - 2.14.1 - settings news pointer, css improved - add debug options - fixes findposts.js (WP 3.9 broken)
...
define('XILILANGUAGE_VER', '2.14.1'); /* used in admin UI*/
