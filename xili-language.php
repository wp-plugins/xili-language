...
# updated 090226 - see 0.9.5 in comments of functions below - latest release for WP 2.6 -> WP 2.7 (next only 2.7.x)
...
<p class="submit"><input type="submit" name="submit" value="<?php echo $submit_text ?>" /></p>
	...
	<div class='wrap'>
	<h3>xili-language - © <a href="http://dev.xiligroup.com" target="_blank" title="<?php _e('Author'); ?>" >xiligroup.com</a>™ - msc 2007-9 - v. <?php echo XILILANGUAGE_VER; ?></h3>
...
function xili_add_pages() {
	 add_options_page(__('Language','xili-language'), __('Language','xili-language'), 'manage_options', 'language_page', 'languages_settings');
}

/**
 * private function for admin page : the language list
 * @since 0.9.0
 *
