...
define('XILILANGUAGE_VER','1.5.0'); /* used in admin UI*/
...
//echo '->'.$id.$langmeta.$targetID.'</br>'; 
	...
	/*multilingual for admin pages and menu*/
		...
		if ($this->notwp3) {
			...
			if (!defined('THEME_TEXTDOMAIN')) {
				if (isset($this->thetextdomain)) { 
					define('THEME_TEXTDOMAIN',$this->thetextdomain); //in WP3 detected by load_theme_textdomain);
					if (is_admin()) {
