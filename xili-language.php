...
define('XILILANGUAGE_VER', '2.15.0'); /* used in admin UI*/
...
// is for this theme ?
	...
	function get_xili_flag_options_description ( ) {
		return array (
				'menu_with_flag' => array ( 'title' => __('Menu with flags', 'xili-language'),
					'description' => __("If checked and if flag images for each language available in Medias table, navigation menu item will display image instead language name.", "xili-language") ),
	...
	function bundled_themes_support_flag () {
		...
		if ( in_array( $current_parent_theme , array( 'twentyten', 'twentyeleven', 'twentytwelve', 'twentythirteen', 'twentyfourteen' ) ) ) {
