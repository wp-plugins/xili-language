...
# updated 090329 - 0.9.8.1 - counting only published posts and pages, add filter for widget's titles, in admin UI link to posts of one language, compatible with xili-tidy-tags to display sub-selection of tags according language.
...
define('XILILANGUAGE_VER','0.9.8.1'); /* used in admin UI*/
 ...
 * @uses $wpdb
 */
if (!function_exists('get_terms_with_order')) { /* if xili-tidy-tags is activated before */
