...
define('XILILANGUAGE_VER','0.9.7.2');
...
class xili_language {
	 ...
	 *
	 * @since 0.9.0
	 * @completed 0.9.8 to record postmeta of linked posts in other languages
	 *
	 * @param $post_ID
	 */
	...
	function xili_language_linked_posts() { 
		...
		<tbody class='list:meta'>
			...
			foreach ($listlanguages as $language) {
				...
				echo $output;	
			} ?>	</tbody></table><br /><small>© xili-language</small>
	<?php
	}
