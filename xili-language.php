...
# updated 150401 - 2.16.5 - WP-REST-API - json compatibility - fixes is_main_query and option stickies -
...
define('XILILANGUAGE_VER', '2.16.5'); /* used in admin UI*/
define('XILILANGUAGE_WP_VER', '3.9'); /* used in error - see at end */
...
// 2.16.5 - WP REST API - JSON is_home not like feed...
					...
					if ( $query_object->is_posts_page ) { // 2.8.4
						...
						//error_log ( ' **MAIN** ' . serialize($query_object->is_main_query()));
						//error_log ( ( isset ( $query_object->query_vars['json_route'] ) )? " *** " . $query_object->query_vars['json_route'] : ' no json route **** ');
						$curlang = $this->choice_of_browsing_language();
						// 2.16.5
