...
# updated 120405 - 2.5.0 - new dashboard metabox for translations list of linked posts and actions (as in XD2), language postmetas now hidden, hreflang link added in head, WP3.4 pre-tests: fixes metaboxes columns
...
define('XILILANGUAGE_VER','2.5-rc2'); /* used in admin UI*/
