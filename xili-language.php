...
# updated 090526 - 0.9.9.5 - php doc enhanced, link to modify linked posts, php4 compatible =& instantiation.
...
define('XILILANGUAGE_VER','0.9.9.5'); /* used in admin UI*/
...
class xili_language {
	...
	function choice_of_browsing_language() {
		...
		if ($this->browseroption != 'browser') return strtolower($this->default_lang); /* in settings UI - after filter to hook w/o UI */
