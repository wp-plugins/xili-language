...
define('XILILANGUAGE_VER','0.9.7.1');
...
class xili_language {
	...
	function xili_language() {
		...
		$this->add_action('xili_language_list');
		
		$this->add_action('xiliml_post_language');
		$this->add_action('xiliml_the_other_posts');
		$this->add_action('xiliml_the_category');
		$this->add_action('xiliml_langinsearchform');
	}
	...
	function myplugin_add_custom_box() {
 		...
 		add_meta_box('xilil', 'xili-language', array(&$this,'xili_language_checkboxes_n'), 'page', 'side','high');
 		add_meta_box('xilil', 'xili-language', array(&$this,'xili_language_checkboxes_n'), 'post', 'side','high');
...
$xili_language = new xili_language(); /* instantiation of xili_language class */
...
/* since 0.9.7.1 can be used in functions.php for special action */
