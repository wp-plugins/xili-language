...
*/
# updated 141221 - 2.16.0 - ready for twentyfifteen and 4.1 - now search also parent mo file in WP_LANG_DIR if not in theme folder
...
define('XILILANGUAGE_VER', '2.16.0'); /* used in admin UI*/
